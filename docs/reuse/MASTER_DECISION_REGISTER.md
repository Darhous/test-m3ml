...
| 99 | 2026-07-16 | CRM and Support | helpdesk-ticketing | ENGINE + ADAPTER: Frappe Helpdesk (AGPL-3.0) | Same-vendor-family fit; **license-drift finding** — unlike ERPNext/Frappe HR (GPL-3.0), newer Frappe apps ship AGPL-3.0, explicitly not assumed clear by inheritance | — |
