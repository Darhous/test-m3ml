...
|---|---|---|---|---|---|---|---|---|---|
| R-01 | Eramba Community low-confidence GRC decision | Compliance-tracking Engine selected with the program's lowest-confidence rating; no stronger alternative found across 28 Modules | Medium | Medium | Medium | **Updated 2026-07-18 (Final Pre-SAD Semantic Consistency Correction):** Eramba remains the conditionally approved Version 1 selection; **not subject to re-evaluation during SAD authoring.** Mitigation is implementation due diligence (license verification, security/maintenance assessment, deployment/integration fit, operational ownership confirmation, exit-strategy validation) before production adoption. A failed due-diligence gate triggers formal governance (a new ADR, Technology Baseline amendment, or EARB decision) — no silent substitution | Audit and Compliance | Open (non-architectural — due-diligence tracking, not a product re-evaluation) | `docs/architecture-review/11-RISKS.md`, `02-TECHNOLOGY-BASELINE.md`, `03-ENGINE-BASELINE.md` |
