...
| 7 | Security, Privacy & Trust Boundaries | **Accepted** — drafted 2026-07-21; self-review verdict PASS (`07-security-privacy-trust-boundaries.md` §35, 3-pass Reader Testing + Final Verification, 29 Gates A–AC); Narrow Security Erratum applied and independently re-verified (§36, §37 Correction Record, commit `3c9bf5a`); finalization corrections applied and independently re-verified during the joint Wave 7/8 review (§38, commit `e4921fe`); formally **Accepted by the Project Owner on 2026-07-21** jointly with Wave 8, satisfying gate condition 3 below (see `07-security-privacy-trust-boundaries.md` §39 Formal Acceptance Record) |
| 8 | Identity, Access and Tenant Governance | **Accepted** — drafted 2026-07-21; self-review verdict PASS (`08-identity-access-tenant-governance.md` §48, 4-pass Reader Testing + Final Verification, 38 Gates A–AL); Narrow IAM Erratum applied and independently re-verified (§49, §50, commit `bb9ff00`); formally **Accepted by the Project Owner on 2026-07-21** jointly with Wave 7, satisfying gate condition 3 below (see `08-identity-access-tenant-governance.md` §51 Formal Acceptance Record) |
| 9 | AI Governance, Device Integration & Other Cross-Cutting Concerns | **Accepted** — drafted 2026-07-21; self-review verdict PASS (`09-ai-governance-device-integration-cross-cutting.md` §37, 6-pass Reader Testing + Final Verification, 46 Gates); Final Cross-Wave correction (§38, commit `d6d5947`); pre-acceptance status-promotion sweep (commit `4a68a3b`); 8-reviewer formal-acceptance pass (commit `47b278b`); formally **Accepted by the Project Owner on 2026-07-21**, satisfying gate condition 3 below (see `09-ai-governance-device-integration-cross-cutting.md` §39 Formal Acceptance Record) |
| 10 | Architecture Decisions & Traceability | **Review** — drafted 2026-07-21; self-review verdict PASS (`10-architecture-decisions-and-traceability.md` §15, 3-pass review); registers ADR-0015 (Proposed, Atomic Event Publication requirement); confirms zero ADR Candidates were raised by Waves 3-9; consolidates the platform-wide Traceability Matrix — **not formally Accepted**; awaits its own future Project Owner review |
...
| `09-ai-governance-device-integration-cross-cutting.md` | 9 | Integration Landscape, Device Integration Gateway, Device Identity and Trust Model, Device Protocol Architecture, Message Normalization/Correlation, Integration Flow Catalog, Event/Broker Architecture, Integration Contract Governance, FHIR Integration Boundary, External Partner Integration, Webhook Architecture, Offline Architecture, AI Integration Architecture, Integration Security/Reliability/Observability, Deployment-Mode Differences, Responsibility Matrix, Threat Model and Traceability, Open Decisions |
| `10-architecture-decisions-and-traceability.md` | 10 | ADR Candidate Register (consolidated New-Decision Audit check across Waves 3-9), Atomic Event Publication Mechanism ADR determination (ADR-0015, Proposed), Webhook Delivery ownership formal-status determination, API Contract Stability Classification, Platform-Wide Traceability Matrix (Constitution to ADR to Decision Register to Wave to Threat), Open Decisions |
