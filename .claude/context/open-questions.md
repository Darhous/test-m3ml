...
**الحالة العامة للملف:** 18 من أصل 31 سؤالًا أدناه تم حسمها في مرحلة "Open
Questions Resolution" (2026-07-18) — التفاصيل الكاملة في
`docs/certification/20-OPEN-QUESTIONS-RESOLUTION.md`. الأسئلة المتبقية
(13) تبقى Legal/Regulatory/Country Dependencies خارج صلاحية القرار
المعماري. المحتوى الأصلي أدناه محفوظ كسجل تاريخي ولم يُحذف.
